...
parser = argparse.ArgumentParser()
parser.add_argument("--root_dir", default="images",type=str, help="输入根路径.")
parser.add_argument("--save_path", type=str,default="labels_", help="输出根路径.")
parser.add_argument("--start_num", type=str,default='5498', help="起始计数.")
